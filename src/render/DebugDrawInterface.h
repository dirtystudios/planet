...
public:
    ...
    virtual void AddRect2D(const Rect2Df& rect, const glm::vec3& color, bool filled = false) = 0;

    virtual void AddLine3D(const glm::vec3& start, const glm::vec3& end, glm::vec3 color) = 0;
    virtual void AddRect3D(const Rect3Df& rect, const glm::vec3& color, bool filled = false) = 0;
};
