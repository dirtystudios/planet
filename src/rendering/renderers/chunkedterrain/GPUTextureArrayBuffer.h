...
private:
    ...
    uint32_t _numTiles;
    graphics::TextureId _textureId;
    GPUTile* _tiles;
    std::list<GPUTile*> _unused;
    std::list<GPUTile*> _used;

public:
    GPUTextureArrayBuffer(uint32_t bufferSize, uint32_t numTiles, graphics::TextureId textureId) {
    ...
    graphics::TextureId GetTextureId() { return _textureId; }
};
